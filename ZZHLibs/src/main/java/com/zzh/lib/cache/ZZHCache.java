package com.zzh.lib.cache;


import com.zzh.lib.cache.handler.BooleanHandler;
import com.zzh.lib.cache.handler.BytesHandler;
import com.zzh.lib.cache.handler.DoubleHandler;
import com.zzh.lib.cache.handler.FloatHandler;
import com.zzh.lib.cache.handler.IntegerHandler;
import com.zzh.lib.cache.handler.LongHandler;
import com.zzh.lib.cache.handler.StringHandler;
import com.zzh.lib.cache.simple.SimpleMultiObjectCache;
import com.zzh.lib.cache.simple.SimpleObjectCache;

public abstract class ZZHCache implements Cache, CacheInfo {
    ...
    public static Cache disk() {
        final Cache cache = new ZZHCache() {
            @Override
